...
export class Convert {
  public static toGetGifsResponse(json: string): GetGifsResponse {
      return cast(JSON.parse(json), r("GetGifsResponse"));
  }

  public static getGifsResponseToJson(value: GetGifsResponse): string {
      return JSON.stringify(uncast(value, r("GetGifsResponse")), null, 2);
  }
}
